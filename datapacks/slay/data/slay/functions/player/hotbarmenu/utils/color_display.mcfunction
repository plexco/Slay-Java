...
replaceitem block 0 8 125 container.0 minecraft:leather_helmet{display:{color:0,Name:'{"translate":"slay.item.display_color","italic":false}'},Unbreakable:1b,HideFlags:36}
