...
# same territory but a grave
execute if score @e[tag=selected,limit=1] group = @s group as @s[scores={handItem=9}] run function slay:player/hotbarmenu/utils/place_unit
