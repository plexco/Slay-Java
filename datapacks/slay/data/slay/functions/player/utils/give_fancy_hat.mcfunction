item replace block 0 8 125 container.0 with minecraft:potion{CustomPotionColor:16777215,HideFlags:1,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],display:{Name:"{\"text\":\"Fancy Helmet\"}",Lore:["{\"text\":\"Because you're better\"}","{\"text\":\"than the others and\"}","{\"text\":\"you know that\"}"]}} 1
