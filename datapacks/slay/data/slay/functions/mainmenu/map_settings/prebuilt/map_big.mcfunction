...
execute if score #mapCd tmp matches ..0 if score map_big menu matches ..-1 run scoreboard players set map_big menu 9
execute if score #mapCd tmp matches ..0 if score map_big menu matches 10.. run scoreboard players set map_big menu 0
