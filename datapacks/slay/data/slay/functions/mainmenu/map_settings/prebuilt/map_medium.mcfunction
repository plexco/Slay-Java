...
execute if score #mapCd tmp matches ..0 if score map_medium menu matches ..-1 run scoreboard players set map_medium menu 17
execute if score #mapCd tmp matches ..0 if score map_medium menu matches 18.. run scoreboard players set map_medium menu 0
