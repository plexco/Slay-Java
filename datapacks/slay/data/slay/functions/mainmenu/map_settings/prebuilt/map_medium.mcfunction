...
execute if score map_medium menu matches ..-1 run scoreboard players set map_medium menu 2
execute if score map_medium menu matches 3.. run scoreboard players set map_medium menu 0
