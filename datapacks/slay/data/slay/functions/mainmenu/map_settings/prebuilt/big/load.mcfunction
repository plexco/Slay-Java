...
execute if score map_big menu matches 8 run data merge block -23 8 77 {posZ:14,name:"slay:maps/big/six_quadrants"}
execute if score map_big menu matches 9 run data merge block -23 8 77 {posZ:14,name:"slay:maps/big/usa"}
