...
execute if score theme settings matches ..0 run scoreboard players set theme settings 5
execute if score theme settings matches 6.. run scoreboard players set theme settings 1
