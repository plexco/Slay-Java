...
execute if score theme settings matches ..0 run scoreboard players set theme settings 3
execute if score theme settings matches 4.. run scoreboard players set theme settings 1
