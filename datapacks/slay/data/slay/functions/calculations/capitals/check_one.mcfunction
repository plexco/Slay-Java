...
execute if score #amount tmp2 matches 0 store success score #worked tmp as @e[type=armor_stand,tag=cell,tag=activegroup,limit=1,sort=random,tag=tree] run function slay:calculations/capitals/make_capital
execute if score #amount tmp2 matches 0 store success score #worked tmp as @e[type=armor_stand,tag=cell,tag=activegroup,limit=1,sort=random,tag=palmtree] run function slay:calculations/capitals/make_capital
