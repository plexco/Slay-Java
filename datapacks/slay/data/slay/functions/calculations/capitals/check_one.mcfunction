...
execute if score #amount tmp2 matches 2.. as @e[type=armor_stand,tag=cell,tag=activegroup,limit=1,scores={tmp=0},tag=capital] run function slay:calculations/capitals/transfer
